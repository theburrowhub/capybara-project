...
\begin{tikzpicture}[node distance=3cm]
    ...
    % Toggle arrow
    \draw[->, very thick, bend left=45] (offensive.north) to node[above] {\textbf{R}} (defensive.north);
    \draw[->, very thick, bend left=45] (defensive.south) to node[below] {\textbf{R}} (offensive.south);
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.6, transform shape]
    ...
    % R and E
    \draw[fill=successcolor!30, thick] (14,0) rectangle (15,1) node[pos=.5] {\textbf{R}};
    \draw[fill=successcolor!30, thick] (15.5,0) rectangle (16.5,1) node[pos=.5] {\textbf{E}};
    
    \node at (15.25,-0.7) {\small Mode/Ability};
    
    % P
    \draw[fill=darkgray!30, thick] (17.5,0) rectangle (18.5,1) node[pos=.5] {\textbf{P}};
    \node at (18,-0.7) {\small Pause};
\end{tikzpicture}
